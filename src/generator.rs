...
impl Generator {
    ...
    fn generate_obj(key: &str, obj: &json::JsonValue, indent: u16) -> Vec<String> {
        let mut tokens = Vec::<String>::new();
    ...
    fn generate(obj: &json::JsonValue, indent: u16) -> Vec<String> {
        let mut tokens = Vec::<String>::new();
...
// Instance
impl Generator {
    pub fn generate_prison(&mut self) -> Vec<String> {
